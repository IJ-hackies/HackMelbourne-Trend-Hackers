// Meme & slang library for prompt rotation.
// Edit freely — anything you add here is eligible for random injection into roasts.
// Goal: keep the persona feeling current and varied, not repetitive.
...
/**
 * Returns a randomized, capped pool of memes/slang for prompt injection.
 * Default: pick 1-2 from each category, then cap the total to keep prompts lean.
 */
