...
export async function getCommitDiff(repoPath: string): Promise<DiffContext> {
...
export async function getPushDiff(repoPath: string, branch: string): Promise<DiffContext> {
  // Diff between previous remote tip (reflog) and current
...
export async function getMergeConflictFiles(repoPath: string): Promise<DiffContext> {
