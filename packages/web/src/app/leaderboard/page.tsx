...
async function getLeaderboard(): Promise<LeaderboardEntry[]> {
  // In production, this would fetch from your deployed API
...
function LoadingTable() {
  return (
    <div className="border border-neutral-800 rounded-lg p-8 bg-neutral-900 text-center text-neutral-500">
      Loading leaderboard...
    </div>
  );
}
